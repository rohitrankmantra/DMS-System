...
const features = [
  {
    ...
    description: "Trusted partner for cybersecurity and IT solutions with proven track record across sectors.",
    icon: Zap,
    color: "#0F4C92",
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    title: "24x7 Rapid Response Team",
    description: "Always-on security operations and incident response to keep you protected at all times.",
    icon: Shield,
    color: "#10B981",
  ...
  },
  {
    ...
    description: "Network security, endpoint protection, threat detection, and infrastructure design.",
    icon: BarChart,
    color: "#F97316",
  ...
  },
  {
    ...
    description: "Leverage partnerships with industry leaders for cutting-edge security solutions.",
    icon: Smartphone,
    color: "#8B5CF6",
    gradient: "from-violet-500 to-purple-500",
  },
  {
    title: "Risk-Driven Approach",
    description: "Proactive vulnerability identification and threat mitigation for business continuity.",
    icon: Globe,
    color: "#3B82F6",
  ...
  },
  {
    ...
    description: "SLA-driven solutions with clear metrics for security posture improvement.",
    icon: Cpu,
    color: "#F59E0B",
