      ...
      <section className="relative overflow-hidden pt-32 pb-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="mt-6 text-4xl md:text-6xl font-black uppercase tracking-tight text-slate-900 heading-tech">What We Do</h1>
            <p className="mt-5 text-lg leading-relaxed text-slate-600 font-medium">We design, deploy, monitor, and audit world-class cybersecurity solutions, powered by our 24x7 rapid response team.</p>
          </div>
        </div>
      </section>
