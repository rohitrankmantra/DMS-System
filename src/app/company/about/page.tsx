        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="mt-6 text-4xl md:text-6xl font-black uppercase tracking-tight text-slate-900 heading-tech">
              D M Systems: <span className="text-[#0F4C92]">About Us</span>
            </h1>
            <p className="mt-5 text-lg leading-relaxed text-slate-600 font-medium">
              D M Systems Pvt. Ltd. is a trusted cybersecurity and IT solutions provider with 27 years of experience. We design, deploy, monitor, and audit world-class security solutions backed by a 24x7 rapid response team.
            </p>
          </div>
        </div>
      </section>
